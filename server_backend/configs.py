...
ipkeys["ROOM 244"] = "127.0.0.1" # These are the IP addresses of the cameras, as well as the name of the location (displayed to the users). add more entries for more camears. This is in the case that the system runs with static IPs.
